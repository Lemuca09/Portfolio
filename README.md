# Dev Back-end • Automação • Ciência de Dados • IA

---

## 💻 Sobre mim

Tenho experiência prática como **Engenheiro de Automação** e desenvolvedor focado em soluções de **Back-end**, **Data Engineering** e **IA aplicada**.

Atualmente curso **Ciência de Dados** e sou formado em **Análise e Desenvolvimento de Sistemas (ADS)**.
...
Ferramenta automatizada para geração de alt text humanizado com foco em SEO utilizando IA e processamento em lote.

## 🔹 Airtable Automation Systems
Conjunto de automações para normalização, enriquecimento e sincronização de dados em múltiplas tabelas.

## 🔹 Data & BI Dashboards
Dashboards e pipelines para análise de dados utilizando SQL, Power BI e Python.
